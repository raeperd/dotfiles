...
vim.o.list = true
vim.opt.listchars = { tab = '» ', trail = '·', nbsp = '␣' } -- use `vim.opt` instead of `vim.o`
...
require('lazy').setup {
...

  {
    ...
    dependencies = {
      { 'mason-org/mason.nvim', opts = {} }, -- Mason must be loaded before its dependents so we need to set it up here.
