  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          -- TODO: Add a way to configure this. how to properly ignore vendor only in go projects?
          file_ignore_patterns = { '^vendor/' },
          vimgrep_arguments = { -- https://github.com/nvim-telescope/telescope.nvim/issues/855#issuecomment-1721253959
            'rg',
            '--color=never',
            '--no-heading',
            '--with-filename',
      ...
      vim.keymap.set('n', '<leader>sl', builtin.lsp_dynamic_workspace_symbols, { desc = '[S]earch [L]sp dynamic workspace symbols' })
